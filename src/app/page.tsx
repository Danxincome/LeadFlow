    ...
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="card p-1.5 shadow-xl shadow-primary-500/5">
            <div className="bg-surface-tertiary rounded-lg p-6 sm:p-8">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="bg-white rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm border border-border-light">
                  <p className="text-sm text-text-primary">Hi there! Welcome to Pristine Auto Detailing. I can help you with pricing, services, or booking an appointment. What can I help you with today?</p>
                </div>
              </div>
              <div className="flex items-start gap-4 mb-4 justify-end">
                <div className="bg-primary-600 rounded-2xl rounded-tr-sm px-4 py-3 max-w-xs">
                  <p className="text-sm text-white">How much for a full detail on my SUV?</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="bg-white rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm border border-border-light">
                  <p className="text-sm text-text-primary">Great question! Our Full Detail package for SUVs starts at $249. It includes a thorough exterior wash, clay bar treatment, polish, wax, full interior cleaning, leather conditioning, and carpet shampooing. Would you like to book an appointment?</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`card p-8 relative ${
                plan.featured ? 'ring-2 ring-primary-600 shadow-lg' : ''
              }`}
            >
              {plan.featured && (
